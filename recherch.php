...
<section class="recherche">
    <form action="" method="post">
        <input type="text" class="box" maxlength="150" 
        placeholder="Rechercher ici" required name="rch">
        <button type="submit" class="fas fa-search" name="rch_btn"></button>
    </form>
</section>

<section class="ctg_prd" style="padding-top: 0; min-height: 100vh;">
    <div class="box-container">
    <?php
    if(isset($_POST['rch']) || isset($_POST['rch_btn'])){
        $rch = $_POST['rch'];
