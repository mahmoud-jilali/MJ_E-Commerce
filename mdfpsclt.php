...
<section class="form-container">
    <form action="" method="post">
        ...
        <input type="password" required name="ancpass" placeholder="Entrer votre mot de passe" 
        class="box">
        <input type="password" required name="nvpass" placeholder="Entrer votre nouveau mot de passe" 
        class="box">
        <input type="password" required name="cnvpass" placeholder="Confirmer votre nouveau mot de passe" 
        class="box">
